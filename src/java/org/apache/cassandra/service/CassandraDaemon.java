...
public class CassandraDaemon
{
    ...
    protected void setup()
    {
        ...
        //ScheduledExecutors.optionalTasks.scheduleWithFixedDelay(ColumnFamilyStore.getBackgroundCompactionTaskSubmitter(), 5, 30, TimeUnit.SECONDS);
        
        //ScheduledExecutors.optionalTasks.scheduleWithFixedDelay(ColumnFamilyStore.getBackgroundCompactionTaskSubmitter(), 20, 5, TimeUnit.SECONDS);
