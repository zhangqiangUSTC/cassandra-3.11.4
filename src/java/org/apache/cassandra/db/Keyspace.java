...
public class Keyspace
{
                                               ...
                                               CompletableFuture<?> future)
    {
        ...
        try (OpOrder.Group opGroup = writeOrder.start())
        {
            ...
            /////////////////////////////////////////////
        if(StorageService.instance.flushedSSTableSize > 20971520) {
            if(StorageService.instance.SSTableNumOfL0 > 150 && StorageService.instance.SSTableNumOfL0 < 500){//600//500//400
                try{
            ...
            if(StorageService.instance.SSTableNumOfL0 >= 500 ){
                try{
                    //Thread.currentThread().sleep(1);
                    Thread.currentThread().sleep(2); //sleep 1ms
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            }
        } else {
            if(StorageService.instance.SSTableNumOfL0 > 600 && StorageService.instance.SSTableNumOfL0 < 2500){ //1000,1500,1200,800
                try{ //600=45K
                    Thread.currentThread().sleep(1); //sleep 1ms
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            if(StorageService.instance.SSTableNumOfL0 >= 2500 ){ //2000
                try{
                    Thread.currentThread().sleep(2); //sleep 1ms
                } catch (InterruptedException e) {
                    e.printStackTrace();
