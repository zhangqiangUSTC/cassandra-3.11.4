...
public abstract class AbstractCompactionStrategy
{
    ...
    {
        Long memtableSize = memtable.getLiveDataSize(); //////
        StorageService.instance.flushedSSTableSize = memtableSize;
        cfs.getTracker().replaceFlushed(memtable, sstables);
        if (sstables != null && !sstables.isEmpty()) {
        //if (sstables != null && !sstables.isEmpty() && memtableSize > 104857600) {//////
            logger.debug("Trigger submitBackground, memtableSize:{}, sstables size:{}", memtableSize, sstables.size());
